...
| 订阅分类 | 默认来源 | 说明 |
| --- | --- | --- |
| AI | Google News：artificial intelligence | 国际 AI 动态聚合。 |
| 科技 | Google News：Technology | 科技产业与产品。 |
| 消费电子 | Google News：consumer electronics | 手机、PC、可穿戴设备等。 |
...
| 社会热搜 | Google News：social media trends | 社会议题与网络趋势。 |
| GitHub | GitHub Blog Atom Feed | GitHub 官方产品、社区与开源动态。 |
